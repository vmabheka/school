...
if __name__ == '__main__':
    ...
    print("LAN (other devices on this network):")
    print("  Find the IPv4 address with:  ipconfig")
    print("  Then clients open:            http://<IPv4-address>:5000")
    print("  If clients cannot connect, open the firewall: netsh advfirewall firewall add rule name=\"Excel Schools LAN Server\" dir=in action=allow protocol=TCP localport=5000 profile=private,domain enable=yes  (as Administrator)")
